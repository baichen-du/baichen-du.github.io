...
## Advanced Statistics for Sociothings using lavaan {.smaller}
...
-   See the package documentation and [the lavaan project](https://lavaan.ugent.be/) for more information.
